...
public:
    ...
    constexpr explicit Quaternion(const double x, const double y,
            const double z, const double w) noexcept :
        x_ {x}, y_ {y}, z_ {z}, w_ {w} { }

    constexpr Quaternion(const Quaternion& other) noexcept : x_ {other.x()},
        y_ {other.y()}, z_ {other.z()}, w_ {other.w()} { }
    ...
    constexpr double w() const noexcept { return w_; }
    ...
    friend constexpr Quaternion operator/(const Quaternion& lhs,
            const double rhs) {
