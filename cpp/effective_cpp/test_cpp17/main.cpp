...
static const std::string source_path {"../../computer_graphics/opengl_tut/"};
static const std::string shad_path {source_path + "shaders/"};
static const std::string tex_path {source_path + "images/"};
