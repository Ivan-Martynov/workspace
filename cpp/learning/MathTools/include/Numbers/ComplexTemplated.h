#ifndef H_INCLUDE_NUMBERS_COMPLEXTEMPLATED_H_H
#define H_INCLUDE_NUMBERS_COMPLEXTEMPLATED_H_H
...
class ComplexTemplated
{
  public:
     ...
     */
    explicit ComplexTemplated(value_type r, value_type i = 0)
        : m_real {r}, m_imag {i}
    {
...
#endif // H_INCLUDE_NUMBERS_COMPLEXTEMPLATED_H_H
