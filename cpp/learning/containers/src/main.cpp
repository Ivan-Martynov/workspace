...
static void test_array_alloc()
{
    ...
    print_array(arr_03);
    arr_03 = Marvin::ArrayAlloc<int>::from_view({-32, 48, 1, -5});
    print_array(arr_03);
    const auto arr_04 {Marvin::ArrayAlloc<double>::from_view(
        std::array<double, 3> {2.3, 5, 2.8})};
    print_array(arr_04);
}
...
static void test_array_fixed()
{
    ...
    auto array_03 {Marvin::ArrayFixed<int, 4>::from_view({2, 0, 4, 5})};
