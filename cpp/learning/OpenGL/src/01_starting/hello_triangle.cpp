...
static void draw_simple_triangles(Marvin::WindowController& window_loader,
...
static void draw_two_triangles(Marvin::WindowController& window_loader)
{
    glEnable(GL_BLEND);
...
int main()
{
    Marvin::WindowController window_loader {};
