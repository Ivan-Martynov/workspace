...
void rotating_cube_loop(GLFWwindow *win, const GLuint VAO, const Shader &shad,
    ...
    // view matrix
    const glm::mat4 view = glm::translate(glm::mat4{1}, glm::vec3(0, 0, -2));
...
void lying_container_loop(GLFWwindow *win, const GLuint VAO, const Shader &shad,
    ...
    // define matrices
    const auto model = glm::rotate(glm::mat4{1}, glm::radians(-55.0f),
            glm::vec3(1, 0, 0));
    const auto view = glm::translate(glm::mat4{1}, glm::vec3{0, 0, -3});
