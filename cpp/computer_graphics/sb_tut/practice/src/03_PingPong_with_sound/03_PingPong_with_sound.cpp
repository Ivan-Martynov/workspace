...
class Simple_PingPong_with_sound : public OpenGL_base
{
private:
...
glm::mat4 Simple_PingPong_with_sound::projection_matrix_ = glm::mat4{};

void Simple_PingPong_with_sound::show_menu(const std::string&) {
    std::cout << "Simple ping pong game\n";

    game_loop();
}

void Simple_PingPong_with_sound::on_resize(const int w, const int h) {
...
void Simple_PingPong_with_sound::process_input(const std::string& input,
...
void Simple_PingPong_with_sound::set_objects() {
...
void Simple_PingPong_with_sound::load_shaders() {
...
void Simple_PingPong_with_sound::calculate_window_size() {
    int win_w, win_h;
...
void Simple_PingPong_with_sound::init_audio() {
    audio_manager_.init_default();

    audio_manager_.test();
}

void Simple_PingPong_with_sound::start_up() {
    glfwSwapInterval(1);
...
void Simple_PingPong_with_sound::move_ball() {
...
void Simple_PingPong_with_sound::render(const int, const double) {
...
void Simple_PingPong_with_sound::game_loop(const int option) {
...
void Simple_PingPong_with_sound::shutdown() {
    //glfwDestroyWindow(window_);
    //glfwTerminate();
}

void Simple_PingPong_with_sound::on_key(const int key, const int action, const int scan,
        const int mods) {
...
int main(const int argc, const char *argv[]) {
    try {
        ...
        auto game = std::make_unique<Simple_PingPong_with_sound>(width, height,
                "Ping Pong");
